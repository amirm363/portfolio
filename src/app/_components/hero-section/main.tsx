      ...
      <div className="container mx-auto ">
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-10">
          ...
          <div className="relative animate-in fade-in-50 slide-in-from-bottom-40 duration-700 ">
            <div className="absolute -inset-[0.3px] rounded-full bg-gradient-to-r from-brand to-brand/30 blur-md opacity-75 max-w-96 max-h-96"></div>
            <Image
              ...
              quality={100}
              priority
              className="rounded-full relative md:w-96 md:h-96"
            />
          </div>
        </div>
